...
*/
const BotName = '💔SAD-BOT💔'; // Nama Bot Whatsapp
...
const grupch2 = 'https://www.youtube.com/channel/UCH1CF2_cQ-bseuB46M04_kw'; // OFFICIAL YT LU 2
...
conn.sendMessage(id, 'Syalom Juga Sahabat Terkasih, Ketik !help/!info/!donasi Contoh !help' ,MessageType.text);
}
else if (text == 'Shalom'){
conn.sendMessage(id, 'Shalom Juga Sahabat Terkasih, Ketik !help/!info/!donasi Contoh !help' ,MessageType.text);
}
...
conn.sendMessage(id, 'Paan Cok? , Ketik !help/!info/!donasi Contoh !help' ,MessageType.text);
}
else if (text == '!owner'){
...
conn.sendMessage(id, 'Paan Cuk?' ,MessageType.text);
}
else if (text == 'Anjing'){
  ...
  var teks = text.replace(/!nulis /, '')
    ...
    .then((res) => {
      imageToBase64(res.data.result)
        .then(
          (ress) => {
            conn.sendMessage(id, '[WAIT] Process...❗', MessageType.text)
